// --- from js/vendor/31f881d7-7a73-414c-988e-526c0bc18b2e.js ---
...
// loader
  window.addEventListener('load', () => {
    ...
    setTimeout(() => l.classList.add('gone'), 1800);
  });
  ...
  // mobile menu
  const mb = document.getElementById('menuBtn'); const mm = document.getElementById('mobileMenu');
  mb && mb.addEventListener('click', () => mm.classList.toggle('hidden'));
  mm && mm.querySelectorAll('a').forEach(a => a.addEventListener('click', () => mm.classList.add('hidden')));

  // smooth-ish in-page anchor scroll
